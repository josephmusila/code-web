...
const Banner = () => {
    return (
        <section className="banner-section index index-2">
                                ...
                                <div className="col-xl-5 col-lg-6 col-md-8">
                                    <div className="main-content">
                                        <div className="top-area section-text">
                                            <h5 className="sub-title">Take your game to the next level</h5>
                                            <h1 className="title">Coaching from Elite</h1>
                                            <p className="xlr">Get better and unlock your potential in the games you love most</p>
                                        </div>
                                        <div className="bottom-area d-xxl-flex">
                                            <Link href="coaching-grid-list" className="cmn-btn">Explore</Link>
